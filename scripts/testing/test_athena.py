"""
Test script for Athena AI Detector
...
def load_model():
    """Load the trained Athena model"""
    print("Loading Athena model...")
    ...
    print("Model loaded! (Trained accuracy: 98.82%)\n")
...
def analyze_text(text, tokenizer, model):
    ...
    print("\n" + "=" * 80)
    print("ATHENA AI DETECTOR RESULTS")
    print("=" * 80)
...
def main():
    ...
    print("=" * 80)
    print("ATHENA AI DETECTOR - Interactive Testing")
    print("=" * 80)
    print("\nModel achieved 98.82% accuracy on test set")
